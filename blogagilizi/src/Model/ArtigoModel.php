   <?php
class ArtigoModel extends AppModel {
    public $name = 'Artigo';

public function beforeSave($options = array())
{
    if(!empty($this->data['Artigo']['photo']['name'])) {
        $this->data['Artigo']['photo'] = $this->upload($this->data['Artigo']['photo']);
    } else {
        unset($this->data['Artigo']['photo']);
    }
}


public function upload($imagem = array(), $dir = 'files/Artigo')
{
    $dir = WWW_ROOT.$dir.DS;
